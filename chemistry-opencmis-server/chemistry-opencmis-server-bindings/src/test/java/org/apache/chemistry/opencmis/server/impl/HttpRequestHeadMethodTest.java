...
public class HttpRequestHeadMethodTest {
    ...
    @Test
    public void testAtomPubHeadRequest()
            throws URISyntaxException, IOException, ServletException {
        String requestURI = CONTEXT_PATH + ATOMPUB_SERVLET_PATH + "/" + 
                REPOSITORY_ID + "/content";
        String queryString = "id=123";
        doTestHeadRequest(new CmisAtomPubServlet(), ATOMPUB_SERVLET_PATH,
    ...
    public void testBrowserBindingHeadRequest()
            throws URISyntaxException, IOException, ServletException {
        String requestURI = CONTEXT_PATH + BROWSER_SERVLET_PATH + "/" + 
                REPOSITORY_ID + "/root";
        String queryString = "cmisselector=content&objectId=123";
        doTestHeadRequest(new CmisBrowserBindingServlet(), BROWSER_SERVLET_PATH,
                requestURI, queryString);
    }
    
    private void doTestHeadRequest(Servlet servlet, String servletPath,
