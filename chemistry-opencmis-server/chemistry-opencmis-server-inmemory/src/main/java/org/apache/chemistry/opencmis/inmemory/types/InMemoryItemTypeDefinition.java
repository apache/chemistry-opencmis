...
public class InMemoryItemTypeDefinition extends ItemTypeDefinitionImpl {

    private static final long serialVersionUID = 1L;
    private static final InMemoryItemTypeDefinition ITEM_TYPE = new InMemoryItemTypeDefinition();

    public static InMemoryItemTypeDefinition getRootItemType() {
        return ITEM_TYPE;
    }
    ...
    public InMemoryItemTypeDefinition() {
        ...
        DocumentTypeCreationHelper.setBasicPropertyDefinitions(props);
    }
    ...
    private void init(String id, String displayName, boolean isBaseType) {
        ...
        setBaseTypeId(BaseTypeId.CMIS_ITEM);
        setId(id);
        if (displayName == null) {
            displayName = id;
        }
