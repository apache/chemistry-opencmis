...
public class CmisServiceWrapper<T extends CmisService> implements CmisService {
	...
	private static final Logger log = LoggerFactory
			.getLogger(CmisServiceWrapper.class);
	...
	public CmisServiceWrapper(T service, BigInteger defaultTypesMaxItems,
			BigInteger defaultTypesDepth, BigInteger defaultMaxItems,
	...
	protected BigInteger getSkipCount(BigInteger skipCount) {
		...
		if (skipCount.compareTo(BigInteger.ZERO) == -1) {
			throw new CmisInvalidArgumentException(
					"skipCount must not be negative!");
		}
	...
	public List<ObjectInFolderContainer> getDescendants(String repositoryId,
		...
		try {
			return service.getDescendants(repositoryId, folderId, depth,
	...
	public String create(String repositoryId, Properties properties,
		...
		try {
			return service.create(repositoryId, properties, folderId,
	...
	public AllowableActions getAllowableActions(String repositoryId,
		...
		try {
			return service.getAllowableActions(repositoryId, objectId,
					extension);
		} catch (Exception e) {
			throw createCmisException(e);
		}
	...
	public Properties getProperties(String repositoryId, String objectId,
		...
		try {
			return service.getProperties(repositoryId, objectId, filter,
					extension);
		} catch (Exception e) {
			throw createCmisException(e);
		}
	...
	public void checkIn(String repositoryId, Holder<String> objectId,
		...
		try {
			service.checkIn(repositoryId, objectId, major, properties,
					contentStream, checkinComment, policies, addAces,
					removeAces, extension);
		} catch (Exception e) {
			throw createCmisException(e);
		}
	...
	public List<ObjectData> getAllVersions(String repositoryId,
		...
		try {
			return service
					.getAllVersions(repositoryId, objectId, versionSeriesId,
	...
	public Acl applyAcl(String repositoryId, String objectId, Acl aces,
		...
		try {
			return service.applyAcl(repositoryId, objectId, aces,
					aclPropagation);
		} catch (Exception e) {
			throw createCmisException(e);
		}
	...
	public Acl applyAcl(String repositoryId, String objectId, Acl addAces,
		...
		try {
			return service.applyAcl(repositoryId, objectId, addAces,
