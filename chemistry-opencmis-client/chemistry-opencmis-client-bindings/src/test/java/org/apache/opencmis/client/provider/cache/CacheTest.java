...
public class CacheTest extends TestCase {
  ...
  public final static String MAP_CACHE_LEVEL = "org.apache.opencmis.client.provider.cache.impl.MapCacheLevelImpl";
  public final static String LRU_CACHE_LEVEL = "org.apache.opencmis.client.provider.cache.impl.LruCacheLevelImpl";
  ...
  public void testCacheConfig() throws Exception {
    ...
    try {
      cache = new CacheImpl();
      cache.initialize(new String[] { "org.apache.opencmis.client.provider.cache.CacheTest" });
    }
    catch (IllegalArgumentException e) {
    }
  }
